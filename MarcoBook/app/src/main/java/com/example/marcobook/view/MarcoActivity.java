...
public class MarcoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.universo_marco);
        ...
        ll_carrinho.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(MarcoActivity.this, CarrinhoActivity.class);
        ...
        ll_favoritos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(MarcoActivity.this, FavoritosActivity.class);
                startActivity(intent);
